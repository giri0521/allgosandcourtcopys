 ...
 * One call opts out: the start-up /auth/refresh legitimately 401s for anyone
 * who is simply not signed in, so it must not bounce a visitor off the register
 * or forgot-password screen.
 */
